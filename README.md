...
dependencies {
    // NeoForge
    implementation group: 'net.darkhax.pigpen', name: 'runelic-neoforge-1.21.1', version: '21.1.0'

    // Forge
    implementation group: 'net.darkhax.pigpen', name: 'runelic-forge-1.21.1', version: '21.1.0'

    // Fabric & Quilt
    modImplementation group: 'net.darkhax.pigpen', name: 'runelic-fabric-1.21.1', version: '21.1.0'

    // Common / MultiLoader / Vanilla
    compileOnly group: 'net.darkhax.pigpen', name: 'runelic-common-1.21.1', version: '21.1.0'
}
```
