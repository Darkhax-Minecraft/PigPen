...
public class PigPen {
    ...
    private void registerCommands (RegisterCommandsEvent event) {
        ...
        final LiteralArgumentBuilder<CommandSource> root = Commands.literal("pigpen");
        ...
        book.then(Commands.literal("encode").executes(ctx -> this.commandBook(ctx, FONT_PIGPEN)));
        ...
        tile.then(Commands.literal("encode").then(Commands.argument("pos", BlockPosArgument.blockPos()).executes(ctx -> this.commandPos(ctx, FONT_PIGPEN))));
    ...
    private int commandSay (CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        final ITextComponent inputMessage = applyFont(new StringTextComponent(StringArgumentType.getString(ctx, "text")), FONT_PIGPEN);
    ...
    private int commandHand (CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        if (sender instanceof LivingEntity) {
            ...
            stack.setDisplayName(applyFont(stack.getDisplayName(), FONT_PIGPEN));
        }
